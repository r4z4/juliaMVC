...
# !!! Main.UserApp is configured as an alias for Main.JuliaMVC and you might encounter it in some tests
using Main.JuliaMVC, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "JuliaMVC tests" begin
  @includetests ARGS
end
